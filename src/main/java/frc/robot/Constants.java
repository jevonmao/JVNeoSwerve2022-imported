...
public final class Constants {
    ...
    public static final int HOOK1_MODULE = 0;
    public static final int HOOK1_CHANNEL = 0;
    public static final int HOOK2_MODULE = 0;
    public static final int HOOK2_CHANNEL = 0;
